...
export default function useApiService() {
    ...
    const createEvent = useCallback(async (eventData: Event): Promise<Event | null> => {
        try {
    ...
    const updateEvent = useCallback(async (id: string, eventData: Event): Promise<Event | null> => {
        try {
