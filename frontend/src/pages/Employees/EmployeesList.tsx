    ...
    <div style={{ padding: 0 }}>
      ...
      >
        <div style={{ marginBottom: 12, color: '#faad14' }}>
          <strong>Disclaimer:</strong> Please provide a CSV file with the columns <code>Name</code>, <code>Last Name</code>, <code>Location</code>, <code>Employment Start Date</code>, <code>Email</code>, <code>Gender</code>, and <code>Gitlab Username</code>. Note: <code>Gitlab Username</code> is optional and can stay empty.
        </div>
        <Button
